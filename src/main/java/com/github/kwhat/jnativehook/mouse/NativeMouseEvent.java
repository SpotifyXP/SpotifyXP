...
public class NativeMouseEvent extends NativeInputEvent {
    ...
    /**
     * The native mouse pressed event. This <code>NativeMouseEvent</code> occurs when a mouse button
    ...
    /**
     * The native mouse released event. This <code>NativeMouseEvent</code> occurs when a mouse
     * button is released.
     */
    public static final int NATIVE_MOUSE_RELEASED = 2 + NATIVE_MOUSE_FIRST;

    /**
     * The native mouse moved event. This <code>NativeMouseEvent</code> occurs when the mouse
     * pointer changes position.
     */
    public static final int NATIVE_MOUSE_MOVED = 3 + NATIVE_MOUSE_FIRST;

    /**
     * The native mouse dragged event. This <code>NativeMouseEvent</code> occurs when the mouse
     * pointer changes position while a mouse button is pressed.
     */
     ...
     * @param modifiers  a modifier mask describing the modifier keys and mouse buttons active for
     *                   the event.
     ...
     * @param y          the y coordinate of the native pointer.
     * @param clickCount the number of button clicks associated with this event.
     * @param button     The mouse buttons that have changed state. NOBUTTON, BUTTON1, BUTTON2,
     ...
     *
     * @return a <code>Point</code> object containing the x and y coordinates of the native pointer
     * @since 1.1
     */
