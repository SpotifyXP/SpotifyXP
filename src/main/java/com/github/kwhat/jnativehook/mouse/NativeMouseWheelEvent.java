 ...
 * <code>NativeMouseWheelEvents</code> reflect the most recent settings.
 *
...
public class NativeMouseWheelEvent extends NativeMouseEvent {
    ...
    /**
     * Only valid for scrollType WHEEL_UNIT_SCROLL. Indicates number of units that should be
     * scrolled per click of mouse wheel rotation, based on platform settings.
     *
     * @see #getScrollType
     * @see #getScrollAmount
     */
    ...
    /**
     * Indicates what sort of scrolling should take place in response to this event, based on
     * platform settings.  Legal values are:
     * <ul>
     ...
     * valid if <code>getScrollType</code> returns
     ...
     * </ul>
     *
     * @return either NativeMouseWheelEvent.WHEEL_UNIT_SCROLL or NativeMouseWheelEvent.WHEEL_BLOCK_SCROLL,
    ...
    /**
     * Returns the direction of scrolling that should take place in response to this event.  Legal
     * values are:
     * <ul>
     ...
     * </ul>
     *
     * @return either NativeMouseWheelEvent.WHEEL_VERTICAL_DIRECTION or NativeMouseWheelEvent.WHEEL_HORIZONTAL_DIRECTION.
     * .
     * @since 2.1
     */
