 ...
 * mdm@techie.com 02/15/99 Java Conversion by E.B, javalayer@javazoom.net
 *
...
final class huffcodetab {
    ...
    private static final int[][] ValTab2 = {{2, 1}, {0, 0}, {4, 1}, {2, 1}, {0, 16}, {0, 1}, {2, 1}, {0, 17}, {4, 1}, {2, 1}, {0, 32},
            {0, 33}, {2, 1}, {0, 18}, {2, 1}, {0, 2}, {0, 34},};

    private static final int[][] ValTab3 = {{4, 1}, {2, 1}, {0, 0}, {0, 1}, {2, 1}, {0, 17}, {2, 1}, {0, 16}, {4, 1}, {2, 1}, {0, 32},
            {0, 33}, {2, 1}, {0, 18}, {2, 1}, {0, 2}, {0, 34},};

    private static final int[][] ValTab4 = {{0, 0}}; // dummy

    private static final int[][] ValTab5 = {{2, 1}, {0, 0}, {4, 1}, {2, 1}, {0, 16}, {0, 1}, {2, 1}, {0, 17}, {8, 1}, {4, 1}, {2, 1},
            {0, 32}, {0, 2}, {2, 1}, {0, 33}, {0, 18}, {8, 1}, {4, 1}, {2, 1}, {0, 34}, {0, 48}, {2, 1}, {0, 3}, {0, 19}, {2, 1},
            {0, 49}, {2, 1}, {0, 50}, {2, 1}, {0, 35}, {0, 51},};

    private static final int[][] ValTab6 = {{6, 1}, {4, 1}, {2, 1}, {0, 0}, {0, 16}, {0, 17}, {6, 1}, {2, 1}, {0, 1}, {2, 1}, {0, 32},
            {0, 33}, {6, 1}, {2, 1}, {0, 18}, {2, 1}, {0, 2}, {0, 34}, {4, 1}, {2, 1}, {0, 49}, {0, 19}, {4, 1}, {2, 1}, {0, 48},
            {0, 50}, {2, 1}, {0, 35}, {2, 1}, {0, 3}, {0, 51},};

    private static final int[][] ValTab7 = {{2, 1}, {0, 0}, {4, 1}, {2, 1}, {0, 16}, {0, 1}, {8, 1}, {2, 1}, {0, 17}, {4, 1}, {2, 1},
    ...
    private static final int[][] ValTab8 = {{6, 1}, {2, 1}, {0, 0}, {2, 1}, {0, 16}, {0, 1}, {2, 1}, {0, 17}, {4, 1}, {2, 1}, {0, 33},
    ...
    private static final int[][] ValTab9 = {{8, 1}, {4, 1}, {2, 1}, {0, 0}, {0, 16}, {2, 1}, {0, 1}, {0, 17}, {10, 1}, {4, 1}, {2, 1},
    ...
    private static final int[][] ValTab10 = {{2, 1}, {0, 0}, {4, 1}, {2, 1}, {0, 16}, {0, 1}, {10, 1}, {2, 1}, {0, 17}, {4, 1}, {2, 1},
    ...
    private static final int[][] ValTab11 = {{6, 1}, {2, 1}, {0, 0}, {2, 1}, {0, 16}, {0, 1}, {8, 1}, {2, 1}, {0, 17}, {4, 1}, {2, 1},
    ...
    private static final int[][] ValTab12 = {{12, 1}, {4, 1}, {2, 1}, {0, 16}, {0, 1}, {2, 1}, {0, 17}, {2, 1}, {0, 0}, {2, 1},
    ...
    private static final int[][] ValTab13 = {{2, 1}, {0, 0}, {6, 1}, {2, 1}, {0, 16}, {2, 1}, {0, 1}, {0, 17}, {28, 1}, {8, 1}, {4, 1},
    ...
    private static final int[][] ValTab15 = {{16, 1}, {6, 1}, {2, 1}, {0, 0}, {2, 1}, {0, 16}, {0, 1}, {2, 1}, {0, 17}, {4, 1}, {2, 1},
    ...
    private static final int[][] ValTab16 = {{2, 1}, {0, 0}, {6, 1}, {2, 1}, {0, 16}, {2, 1}, {0, 1}, {0, 17}, {42, 1}, {8, 1}, {4, 1},
    ...
    private static final int[][] ValTab24 = {{60, 1}, {8, 1}, {4, 1}, {2, 1}, {0, 0}, {0, 16}, {2, 1}, {0, 1}, {0, 17}, {14, 1},
    ...
    private static final int[][] ValTab32 = {{2, 1}, {0, 0}, {8, 1}, {4, 1}, {2, 1}, {0, 8}, {0, 4}, {2, 1}, {0, 1}, {0, 2}, {8, 1},
            {4, 1}, {2, 1}, {0, 12}, {0, 10}, {2, 1}, {0, 3}, {0, 6}, {6, 1}, {2, 1}, {0, 9}, {2, 1}, {0, 5}, {0, 7}, {4, 1}, {2, 1},
            {0, 14}, {0, 13}, {2, 1}, {0, 15}, {0, 11},};

    private static final int[][] ValTab33 = {{16, 1}, {8, 1}, {4, 1}, {2, 1}, {0, 0}, {0, 1}, {2, 1}, {0, 2}, {0, 3}, {4, 1}, {2, 1},
