...
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.authorization.authorization_code.AuthorizationCodeRefreshRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.authorization.authorization_code.AuthorizationCodeRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.authorization.authorization_code.AuthorizationCodeUriRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.authorization.authorization_code.pkce.AuthorizationCodePKCERefreshRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.authorization.authorization_code.pkce.AuthorizationCodePKCERequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.authorization.client_credentials.ClientCredentialsRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.albums.GetAlbumRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.albums.GetAlbumsTracksRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.albums.GetSeveralAlbumsRequest;
...
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.personalization.GetUsersTopArtistsAndTracksRequest;
...
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.player.*;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.playlists.*;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.search.SearchItemRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.search.simplified.*;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.search.simplified.special.SearchAlbumsSpecialRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.shows.GetSeveralShowsRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.shows.GetShowRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.shows.GetShowsEpisodesRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.tracks.*;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.users_profile.GetCurrentUsersProfileRequest;
import com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.users_profile.GetUsersProfileRequest;
...
public class SpotifyApi {
   ...
   * @see <a href="https://developer.spotify.com/web-api/user-guide/#spotify-uris-and-ids">Spotify: URLs &amp; IDs</a>
   */
  public com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.follow.FollowPlaylistRequest.Builder followPlaylist(String playlist_id, boolean public_) {
    return new com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.follow.FollowPlaylistRequest.Builder(accessToken)
      .setDefaults(httpManager, scheme, host, port)
      .playlist_id(playlist_id)
      .public_(public_);
  }
   ...
   * @return An {@link com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.follow.legacy.UnfollowPlaylistRequest.Builder}.
   * @see <a href="https://developer.spotify.com/web-api/user-guide/#spotify-uris-and-ids">Spotify: URLs &amp; IDs</a>
   */
  public com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.follow.legacy.UnfollowPlaylistRequest.Builder unfollowPlaylist(String owner_id, String playlist_id) {
    return new com.spotifyxp.deps.se.michaelthelin.spotify.requests.data.follow.legacy.UnfollowPlaylistRequest.Builder(accessToken)
      .setDefaults(httpManager, scheme, host, port)
      .owner_id(owner_id)
      .playlist_id(playlist_id);
  }
