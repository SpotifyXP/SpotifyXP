...
/**
 * <p>A no-operation implementation of {@link org.slf4j.spi.LoggingEventBuilder}.</p>
 *
...
public class NOPLoggingEventBuilder implements org.slf4j.spi.LoggingEventBuilder {
    ...
    @Override
    public org.slf4j.spi.LoggingEventBuilder addKeyValue(String key, Supplier<Object> value) {
        return singleton();
    }
