...
/**
 * A default implementation of {@link org.slf4j.event.LoggingEvent}.
 * 
...
public class DefaultLoggingEvent implements LoggingEvent {
    ...
    List<org.slf4j.event.KeyValuePair> keyValuePairs;
    ...
    public void addKeyValue(String key, Object value) {
        getNonnullKeyValuePairs().add(new org.slf4j.event.KeyValuePair(key, value));
    }

    private List<org.slf4j.event.KeyValuePair> getNonnullKeyValuePairs() {
